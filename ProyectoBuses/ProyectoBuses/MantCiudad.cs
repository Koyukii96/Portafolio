    ...
    public partial class MantCiudad : Form
    {
        ...
        private void btnCrear_Click(object sender, EventArgs e)
        {
            try
            {
                if (txtNombre.Text != "")
                {
                    string codigo = "insert into CIUDAD (NOMBRE_CIUDAD) values(@nombre) ";
        ...
        private void btnActualizar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (txtNombre.Text != "")
                {
                    string update = "update CIUDAD set NOMBRE_CIUDAD =@nombre where ID_CIUDAD = @id";
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            try
            {
                if (txtNombre.Text != "")
                {
                    string codigo = "delete CIUDAD where ID_CIUDAD=@id";
                    cmd = new SqlCommand(codigo, con);
                    MessageBox.Show(codigo);
                    con.Open();
                    cmd.Parameters.AddWithValue("@id", ID);
